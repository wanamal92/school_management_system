...
urlpatterns = [
    ...
    path('teacher-duties/create/', views.create_teacher_duty,
         name='create_teacher_duty'),
    path('teacher-duties/edit/<int:pk>/',
         views.edit_teacher_duty, name='edit_teacher_duty'),
    path('teacher-duties/delete/<int:pk>/',
         views.delete_teacher_duty, name='delete_teacher_duty'),
]
