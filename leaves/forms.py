...
class LeaveRequestForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['teacher'].widget.attrs['readonly'] = True  # Make teacher field read-only
        self.fields['teacher'].queryset = Teacher.objects.all()  # All teachers can be selected
        self.fields['leave_type'].queryset = LeaveType.objects.all()  # All leave types can be selected
