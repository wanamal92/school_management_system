...
class StudentForm(forms.ModelForm):
    class Meta:
        ...
        class_level = forms.ModelChoiceField(queryset=Class.objects.all(), empty_label="Select Class")
        guardian = forms.ModelChoiceField(queryset=Guardian.objects.all(), empty_label="Select Guardian")
