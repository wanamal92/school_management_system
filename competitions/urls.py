...
urlpatterns = [
    ...
    path('results/', views.list_competition_results,
         name='list_competition_results'),
    path('results/create/', views.create_competition_result,
         name='create_competition_result'),
    path('results/edit/<int:pk>/', views.edit_competition_result,
